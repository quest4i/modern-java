...
public class LambdaExample {
    ...
    public static void main(String[] args) {
        ...
        final List<Integer> numbers = IntStream.range(1, 21).boxed().collect(Collectors.toList());
//        System.out.println(numbers.getClass().getName() + " : " + numbers);
    ...
    private static void fileringTesst() {
    ...
    private static void parallelProgramming() {
        ...
        final int total = Arrays.asList(1, 2, 3)
                .parallelStream()
                .peek(i -> {
